...
export default function welcome() {  
  return (
    <div>
        <p style={{ fontSize: 30 }}><b><u><center>INSTRUCTIONS</center></u></b></p>
        <h2><b>Admin Instructions</b></h2>
        <h3>1. All Teachers</h3>
        <h4>   List of existing teachers.</h4>
        <ul>
          <li>Add New - Create new teacher account.</li>
          <li>Action - <br/> <p style={{marginBottom:'2px'}}><Button size = 'small' type="primary" shape="circle" icon="edit" /> Edit teacher details.</p><Button size = 'small' type="primary" shape="circle" icon="delete" /> Delete teacher account.</li>
        </ul>
        <h3>2. All Courses</h3>
        ...
        <br/>
        <h2><b>Teachers Instructions</b></h2>
        ...
        <ul>
          <li>Action - <Button size = 'small' type="primary" shape="circle" icon="info" /> <ul>
            ...
            <li>Students - List of Registered Candidates</li>
            <li>Statistics - <ul>
        ...
        <ul>
          ...
          <ul>
            <li>Registration link - The link for Registration of student for the test.</li>
          ...
          <p><b>NOTE-</b>A link for this test has been sent to the email id of registered Students. Click on the link to take test.</p>
        </ul>
